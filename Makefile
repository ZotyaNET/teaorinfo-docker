...
install: build start composer-install composer-update yarn-install yarn-upgrade yarn-build migrate key-generate ## Build and start dev environment
...
yarn-install: ## Updates composer dependencies
	@make exec-bash cmd="yarn install"

yarn-upgrade: ## Updates composer dependencies
	@make exec-bash cmd="yarn upgrade"

yarn-build: ## Updates composer dependencies
	@make exec-bash cmd="yarn build"
